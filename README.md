...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/dependente-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14941&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/dependente-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `dependente` can be installed with:

```
conda install dependente
```

It is possible to list all of the versions of `dependente` available on your platform with:
